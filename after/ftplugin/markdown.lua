pcall(vim.keymap.del, "i", "<leader>f", { buffer = true })
pcall(vim.keymap.del, { "n", "i" }, "<leader>r", { buffer = true })

vim.keymap.set("i", "<localleader>f", "<Plug>AddVimFootnote", { buffer = true })
vim.keymap.set({ "n", "i" }, "<localleader>r", "<Plug>ReturnFromFootnote", { buffer = true })
